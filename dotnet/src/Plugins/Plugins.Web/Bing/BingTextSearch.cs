...
public sealed class BingTextSearch : ITextSearch
{
    ...
    async public Task<KernelSearchResults<string>> SearchAsync(string query, TextSearchOptions? searchOptions = null, CancellationToken cancellationToken = default)
    {
        ...
        // TODO Support total count
        return new KernelSearchResults<string>(this.GetResultsAsStringAsync(searchResponse, cancellationToken), null, GetResultsMetadata(searchResponse));
    }
    ...
    async public Task<KernelSearchResults<TextSearchResult>> GetTextSearchResultsAsync(string query, TextSearchOptions? searchOptions = null, CancellationToken cancellationToken = default)
    {
        ...
        // TODO Support total count
        return new KernelSearchResults<TextSearchResult>(this.GetResultsAsTextSearchResultAsync(searchResponse, cancellationToken), null, GetResultsMetadata(searchResponse));
    }
    ...
    async public Task<KernelSearchResults<object>> GetSearchResultsAsync(string query, TextSearchOptions? searchOptions = null, CancellationToken cancellationToken = default)
    {
        ...
        // TODO Support total count
        return new KernelSearchResults<object>(this.GetResultsAsWebPageAsync(searchResponse, cancellationToken), null, GetResultsMetadata(searchResponse));
    }
    ...
    private async Task<BingSearchResponse<BingWebPage>?> ExecuteSearchAsync(string query, TextSearchOptions? searchOptions = null, CancellationToken cancellationToken = default)
    {
    ...
    private static string BuildQuery(string query, TextSearchOptions searchOptions)
    {
        ...
        if (searchOptions.BasicFilter is not null)
        {
            ...
            var filterClause = filterClauses.FirstOrDefault(c => (c as EqualityFilterClause)?.FieldName.Equals("site", StringComparison.OrdinalIgnoreCase) ?? false);
